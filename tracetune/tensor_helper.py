# from https://github.com/PeterGriffinJin/Search-R1/blob/main/search_r1/llm_agent/tensor_helper.py
import torch
...
class TensorHelper:
    ...
    def cut_to_effective_len(self, tensor_dict: Dict[str, torch.Tensor], 
        ...
        effective_len = int(tensor_dict['attention_mask'].sum(dim=1).max())
